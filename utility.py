...
# Embedded file name: controllers\utility.py
"""
...
from fit_function_factory import fit_functions
...
def compute_line_orientation(image, blur, min_len=10, spline=3, expansion=1, expansion2=1):
    ...
    # cv2.imwrite('C:\\Users\\biophys\\Documents\\Klosters\\skel.tif', skeleton)
...
def fit_data_to(func, x, data, expansion=1, chi_squared=False, center=None):
    ...
    if chi_squared:
        ...
        return (
         optim, [err, result.cost])
    else:
        return optim
# okay decompiling controllers.utility.pyc
